...
$realShot = @{
  ...
  'menu-edit'     = @{ file = 'parity\reference\labelshop\r162-menu-01-edit.png'; label = '原版 LabelShop（编辑菜单弹出，round-156 真机）' }
  'menu-view'     = @{ file = 'parity\reference\labelshop\r162-menu-02-view.png'; label = '原版 LabelShop（查看菜单弹出，round-156 真机）' }
  'menu-tool'     = @{ file = 'parity\reference\labelshop\r162-menu-03-tool.png'; label = '原版 LabelShop（工具菜单弹出，round-156 真机）' }
  'menu-arrange'  = @{ file = 'parity\reference\labelshop\r162-menu-04-arrange.png'; label = '原版 LabelShop（排列菜单弹出，round-156 真机）' }
  'menu-database' = @{ file = 'parity\reference\labelshop\r160-db-menu.png'; label = '原版 LabelShop（数据库菜单弹出，round-156 真机）' }
